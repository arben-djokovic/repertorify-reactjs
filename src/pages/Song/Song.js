...
import './song.scss'
import { faEllipsisV, faFilePdf, faShuffle } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div className='song page pageContent'>
        <div className="icons">
            ...
            <FontAwesomeIcon id='icon' className='modalIcon' onClick={(e) => setIsEllipsisOpen(!isEllipsisOpen)} icon={faEllipsisV} />
